...
/* 
*     (4 pts) What is the worst-case Big-O of the insert () algorithm for the AVL tree? Explain.
...
*     (3 pts) What is the worst-case Big-O of the printInOrder () algorithm for the AVL tree? Explain.
